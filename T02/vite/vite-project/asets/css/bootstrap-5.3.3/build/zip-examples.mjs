...
const cssFiles = [
  ...
  'bootstrap-5.3.3.min.css.map',
  'bootstrap-5.3.3.rtl.min.css',
  'bootstrap-5.3.3.rtl.min.css.map'
]
const jsFiles = [
  'bootstrap-5.3.3.bundle.min.js',
  'bootstrap-5.3.3.bundle.min.js.map'
]
const imgFiles = [
  'bootstrap-5.3.3-logo.svg',
  'bootstrap-5.3.3-logo-white.svg'
]
const staticJsFiles = [
  'color-modes.js'
]
