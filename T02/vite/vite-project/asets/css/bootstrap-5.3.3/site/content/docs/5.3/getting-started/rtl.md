...
<html lang="ar" dir="rtl">
  ...
  <body>
    ...
    <!--
    <script bootstrap-5.3.3="{{< param "cdn.popper" >}}" integrity="{{< param "cdn.popper_hash" >}}" crossorigin="anonymous"></script>
    <script bootstrap-5.3.3="{{< param "cdn.js" >}}" integrity="{{< param "cdn.js_hash" >}}" crossorigin="anonymous"></script>
    -->
  </body>
</html>
```
