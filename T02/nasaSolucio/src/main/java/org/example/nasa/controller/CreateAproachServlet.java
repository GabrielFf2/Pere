...
public class CreateAproachServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        String impl = Session.getAttribute(req,"implementation") == null ? "ORM" : Session.getAttribute(req,"implementation");
        AsteroidService asteroidService = ServiceFactory.implementation(impl).createAsteroidService();
        AproachService aproachService = ServiceFactory.implementation(impl).createAproachService();
